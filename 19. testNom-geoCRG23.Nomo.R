...
#Read input file
data=read.table("merge1.txt", header=T, sep="\t", check.names=F, row.names=1)
...
dc=decision_curve(Type ~ Sdhb+Pdha1+Ndufb2+Ndufb6, data=rt, 
